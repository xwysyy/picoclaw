...
为了减少根目录噪音，历史版本/过程文档已移动到 `docs/archive/2026-03/`：

- `docs/archive/2026-03/ROADMAP_V1.md`：原根目录 `ROADMAP.md`（完整版）
- `docs/archive/2026-03/ROADMAP_V2.md`：V2 backlog（ref 深挖结论）
- `docs/archive/2026-03/ROADMAP_V3.md`：V3 重构执行路线
- `docs/archive/2026-03/ROADMAP_V4.md`：V4（含 upstream 同步收敛）
- `docs/archive/2026-03/refactor_guide1.md`：重构指南（ports/adapters + 分层）
